...
* **Плюсы:**
  ...
  * **Удобство:** Никакой консоли (примечание редактора: но можно и в консоле, что не парится над реализацией GUI, по крайней мере на этапе MVP) — перетащили видео, подождали 15 секунд, скачали готовый результат.
* **Минусы:**
